...
<head>
    ...
    <title>Sge Tarso - Cadastro Usuario</title>
	<!-- FAVICON -->
...
<button type="button" class="btn btn-danger btn-lg" onclick="location.href='cadastro_usuario.php'" value="Resetar Formulario" >
