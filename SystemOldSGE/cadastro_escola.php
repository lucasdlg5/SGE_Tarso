...
<head>
    ...
    <title>Sge Tarso - Cadastro Escola</title>
	<!-- FAVICON -->
                ...
                <div class="row">
					...
					<ol class="breadcrumb">
					  <li><a href="dashboard.php">Home</a></li>
  					  <li class="active">Cadastro Escola</li> 
					</ol>
					
                        <h1>Cadastro de Escola Novo</h1>
...
<form>
<div class="input-group">
  <span class="input-group-addon" id="sizing-addon2">Nome Completo da Escola</span>
  <input name="nomeEscola" type="text" class="form-control" placeholder="Nome Completo do Professor" aria-describedby="sizing-addon2">
</div>
<br>
...
<div class="dropdown">
  ...
  <a href="cadastro_materia.php" class="btn btn-primary" id="cadastro_materia">Nao encontrou a diretor? Gerencie!</a>
...
<div class="input-group">
  ...
  <input name="cepEscola" type="text" class="form-control" placeholder="CEP" aria-describedby="sizing-addon2">
</div>
...
<button type="button" class="btn btn-danger btn-lg" onclick="location.href='cadastro_escola.php'" value="Resetar Formulario" >
