...
<head>
    ...
    <title>Sge Tarso - Cadastro Materia</title>
                ...
                <div class="row">
					...
					<ol class="breadcrumb">
					  <li><a href="dashboard.php">Home</a></li>
  					  <li class="active">Cadastro Materia</li> 
					</ol>
					
                        <h1>Cadastro de Materia Nova</h1>
...
<form>
	<div class="input-group">
  <span class="input-group-addon" id="sizing-addon2">Nome da Matéria</span>
  <input name="nomeMateria" type="text" class="form-control" placeholder="Nome da Matéria" aria-describedby="sizing-addon2">
</div>
<br>
	<div class="input-group">
...
<div class="dropdown">
  <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
    Selecione o professor(a) da matéria
    <span class="caret"></span>
  </button>
  <a href="cadastro_curso.php" class="btn btn-primary" id="cadastro_curso">Nao encontrou o professor? Cadastre!</a>
  <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
    <li><a href="#">Girafales</a></li>
    <li><a href="#">Giuliano</a></li>
    <li><a href="#">Marcos Allan</a></li>
    <li><a href="#">Luscão</a></li>
  </ul>
</div>
...
<button type="button" class="btn btn-danger btn-lg" onclick="location.href='cadastro_materia.php'" value="Resetar Formulario" >
