...
<head>
    ...
    <title>Sge Tarso - Gerenciador SGE</title>
	<!-- FAVICON -->
                ...
                <div class="row">
					...
					<ol class="breadcrumb">
					  <li><a href="dashboard.php">Home</a></li>
  					  <li class="active">Gerenciador SGE</li> 
					</ol>

					
                        <h1>Gerenciador SGE</h1>
...
<br>
  ...
  <li role="presentation"><a href="consulta_usuario.php">Consulta de Usuario</a></li>
